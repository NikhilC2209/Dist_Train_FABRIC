...
class MultiGPUClassifier(torch.nn.Module):
    def __init__(self, roberta_model):
        ...
        self.encoder = roberta_model.roberta.encoder.to('cuda:0')
        self.classifier = roberta_model.classifier.to('cuda:0')
...
print("Training data for Batch size 32 over a single GPU's")
print(end-start)